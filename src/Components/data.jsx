...
export const HowWeWorkData = [
  {
    id: 1,
    title: "Build a new product with us",
    icon: <FaHandsHelping />,
    text: "You need to achieve new outcomes with new technology. We guide and deliver across your product lifecycle, from idea to MVP to success at scale. ",
  },
  {
    id: 2,
    title: "Hire your dedicated team",
    icon: <FaUsers />,
    text: "You need a team to design, build, and scale your vision.We tailor your team with all the right pieces to deliver, and scale up and down as needed",
  },
  {
    id: 3,
    title: "Augment your existing team",
    icon: <SiGooglecolab />,
    text: "You need extra capacity to execute your product roadmap.We provide people with the skills you need, and work alongside your existing team{",
  },
];
